/*Examples of JOINS Command & Statement*/
...
/*Task_Example:  Select the names and job start dates of all employees who work for the department number*/
...
/*Select the names, job start dates, and job titles of all employees who work for the department*/
